...
import { botMetadataCertificate, botMetadataSignature, prepareRichResponseMessage } from './rich-message-utils.js';
...
export const generateWAMessageContent = async (message, options) => {
    ...
    if (anyMsg.buttons !== undefined && anyMsg.buttons !== null) {
        const buttonsMessage = {
            buttons: anyMsg.buttons.map((b) => ({ ...b, type: proto.Message.ButtonsMessage.Button.Type.RESPONSE }))
        };
 ...
 */
export const wrapWithBotForwardedMessage = (message, options = {}) => {
    ...
    if (message.botForwardedMessage ||
    ...
    const existingContext = message.messageContextInfo || {};
