 ...
 */
export const generateFallbackWaveform = (length = 64) => {
 ...
 */
export const formatWaveform = (waveform, targetLength = 64) => {
...
const pcmToWaveform = (buf, samples = 64) => {
    if (!buf || buf.length < 2)
        return null;
...
const extractWaveformWithFfmpeg = async (input, samples = 64) => {
