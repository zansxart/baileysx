...
import type { AuthenticationCreds, BaileysEventEmitter, CacheStore, SignalKeyStoreWithTransaction, SignalRepositoryWithLIDStore, SocketConfig, WAMessage, WAMessageKey, MessageUpsertType } from '../Types/index.js';
...
export declare const cleanMessage: (message: WAMessage, meId: string, meLid: string, bypassViewOnce?: boolean) => void;
...
declare const processMessage: (message: WAMessage, { shouldProcessHistoryMsg, placeholderResendCache, ev, creds, signalRepository, keyStore, logger, options, getMessage, upsertMessage, bypassViewOnce }: ProcessMessageContext) => Promise<void>;
