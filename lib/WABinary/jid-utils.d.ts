...
export declare const jidToLid: (jid: string | undefined) => string | undefined;
export declare const storeLidPnMapping: (lid: string, pn: string) => void;
export declare const getPnForLid: (lid: string) => string | null;
export declare const getLidForPn: (pn: string) => string | null;
